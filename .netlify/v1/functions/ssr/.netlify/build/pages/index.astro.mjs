import { c as createComponent, m as maybeRenderHead, a as addAttribute, r as renderComponent, b as renderTemplate, d as renderScript, e as createAstro, f as renderHead, g as renderSlot } from '../chunks/astro/server_BLnWuV8g.mjs';
import 'kleur/colors';
import 'html-escaper';
import { jsxs, jsx } from 'react/jsx-runtime';
import { $ as $$Image } from '../chunks/_astro_assets_BiJ34eHq.mjs';
import 'clsx';
/* empty css                                 */
...
const $$Services = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<section class="py-16" id="services"> <div class="mb-12 rounded-lg bg-red-700"> <div class="container mx-auto px-4"> <h2 class="py-6 text-center text-4xl font-bold text-white">Services</h2> </div> </div> <div class="grid gap-8 md:grid-cols-3"> ${services.map((service) => renderTemplate`<div class="group relative h-96 overflow-hidden rounded-lg shadow-lg"> ${renderComponent($$result, "Image", $$Image, { "src": service.image, "alt": service.title, "width": 500, "height": 500, "class": "absolute inset-0 h-full w-full object-cover transition-transform duration-300 group-hover:scale-110", "loading": "eager", "fetchpriority": "low" })} <div class="bg-opacity-50 group-hover:bg-opacity-70 absolute inset-0 flex flex-col justify-end bg-black p-6 text-white transition-opacity duration-300"> <h3 class="mb-3 text-2xl font-bold">${service.title}</h3> </div> </div>`)} </div> </section>`;
    ...
    /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-2", children: galleries.map((gallery, index) => /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-black/70 to-transparent opacity-0 transition-opacity duration-300 group-hover:opacity-100", children: /* @__PURE__ */ jsx("div", { className: "absolute right-0 bottom-0 left-0 p-4 text-white", children: /* @__PURE__ */ jsx("h3", { className: "mb-2 text-xl font-bold", children: gallery.name }) }) })
        ]
      },
      index
    )) }),
    selectedGallery && /* @__PURE__ */ jsxs("div", { className: "bg-opacity-90 fixed inset-0 z-50 flex items-center justify-center bg-black", children: [
      /* @__PURE__ */ jsx(
        "button",
        {
...
const $$Testimonials = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<section class="py-16" id="testimonials"> <div class="container mx-auto"> <div class="mb-12 rounded-lg bg-red-700"> <div class="container mx-auto px-4"> <h2 class="py-6 text-center text-4xl font-bold text-white">
Testimonials
</h2> </div> </div> <h3 class="mb-12 text-center">
...
</h3> ${testimonials.map((testimonial) => renderTemplate`<div class="group relative overflow-hidden py-4"> <p class="text-left">${testimonial.quote}</p> <p class="pt-4 pb-8 text-right font-bold"> ${testimonial.name}, ${testimonial.location} </p> </div>`)} </div> </section>`;
}, "/Users/kyle/Documents/Repos/jaiscudderplumbing/src/components/Testimonials.astro", void 0);

const $$Contact = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<div class="container mx-auto" id="contact"> <div class="mb-12 rounded-lg bg-red-700"> <div class="container mx-auto px-4"> <h2 class="py-6 text-center text-4xl font-bold text-white">Contact Us</h2> </div> </div> <div class="mt-12"> <div class="mb-8 text-center"> <h2 class="font-light">Please contact Jai Scudder on:</h2> </div>  <div class="flex flex-col items-center justify-center"> ${contactPoints.map((contact) => {
    const Icon = contact.icon;
